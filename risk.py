...
def get_calendar_data():
    """Recupera i dati per il calendario: demo se su Cloud, reali se MT5 è presente."""
    ...
    # DATI DEMO PROFESSIONALI (Per far apparire i quadratini verdi/rossi online come nell'app)
    dr = pd.date_range(end=datetime.now(), periods=30)
    # Lista di profitti realistici basati sulla tua immagine
